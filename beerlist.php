...
<head>
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-35043825-1']);
                                    	...
                                    	<div class="menu-padd">
                                        	<div class="top-line">
                                            	<div class="top-line-bg">
                                                	Follow us on  <a class="decor" href="http://www.facebook.com/BerniesTapRoom"target=â€_blankâ€>Facebook</a>
                                                </div>
                                            </div>
                	...
                	<div class="wrapper">
                    	<div class="grid_12">
                        	<div class="footer-padd">
                            	<div class="wrapper">
                            		<span class="footer-links"><span class="color-1">Bernie's Tap Room</span> &copy; 2012
                                </div>
                            </div>
                        </div>	
                    </div>
